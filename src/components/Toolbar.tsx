...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <>
      ...
      <div className="h-14 bg-radiant-panel border-b border-radiant-border flex items-center px-2 gap-1 relative z-30 overflow-visible select-none shrink-0 justify-between">
        <div className="flex items-center gap-1 overflow-visible">
          {/* 1. Primary Navigation Tools (Window, Pan, Zoom, Loupe) */}
          <div className="flex items-center gap-0.5 pr-1.5 border-r border-radiant-border">
            <button
          ...
          <div className="flex items-center gap-0.5 px-1.5 border-r border-radiant-border">
            <button
            ...
            {/* ROI Tools Menu (Rect ROI, Oval ROI, HU Probe) */}
            <div className="relative">
              <button
                ...
                className={`flex flex-col items-center justify-center min-w-[44px] px-1.5 h-11 rounded transition-all text-[10px] gap-0.5 border ${
                  isRoiActive
                    ? 'bg-purple-900/30 text-purple-300 border-purple-400/80 font-bold'
              ...
              {showRoiMenu && (
                <div className="absolute left-0 top-full mt-1 w-52 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-1 z-50 text-xs space-y-0.5">
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center justify-between ${
                      activeTool === 'rectangle_roi' ? 'text-purple-300 font-bold bg-purple-950/40' : 'text-slate-200'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center justify-between ${
                      activeTool === 'ellipse_roi' ? 'text-pink-300 font-bold bg-pink-950/40' : 'text-slate-200'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center justify-between ${
                      activeTool === 'hu_probe' ? 'text-rose-300 font-bold bg-rose-950/40' : 'text-slate-200'
                    }`}
                  >
                    <div className="flex items-center gap-2">
            ...
            {/* Angles & Spine Menu (Cobb Angle & 3-Point Angle) */}
            <div className="relative">
              <button
                onClick={() => {
                ...
                className={`flex flex-col items-center justify-center min-w-[44px] px-1.5 h-11 rounded transition-all text-[10px] gap-0.5 border ${
                  isAngleActive
                    ? 'bg-amber-900/30 text-amber-300 border-amber-400/80 font-bold'
                    : 'hover:bg-radiant-hover text-slate-300 border-transparent'
                }`}
              ...
              {showAngleMenu && (
                <div className="absolute left-0 top-full mt-1 w-52 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-1 z-50 text-xs space-y-0.5">
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center justify-between ${
                      activeTool === 'angle' ? 'text-emerald-300 font-bold bg-emerald-950/40' : 'text-slate-200'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <Compass className="w-3.5 h-3.5 text-emerald-400" />
                  ...
                  <button
                    ...
                    className={`w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center justify-between ${
                      activeTool === 'cobb_angle' ? 'text-amber-300 font-bold bg-amber-950/40' : 'text-slate-200'
                    }`}
                  >
                    <div className="flex items-center gap-2">
          ...
          {/* 3. Orientation & Transformations (Compact on smaller screens) */}
          <div className="flex items-center gap-0.5 px-1.5 border-r border-radiant-border">
            ...
            {/* Compact Orient Dropdown for standard & laptop screens */}
            <div className="relative 2xl:hidden">
              <button
                ...
                className="flex flex-col items-center justify-center min-w-[42px] px-1.5 h-11 rounded hover:bg-radiant-hover text-slate-300 text-[10px] gap-0.5 border border-transparent"
              ...
              {showTransformMenu && (
                <div className="absolute left-0 top-full mt-1 w-44 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-1 z-50 text-xs space-y-0.5">
                  <button
                    onClick={() => {
                      onRotate();
                      setShowTransformMenu(false);
                    }}
                    className="w-full px-2.5 py-1.5 text-left rounded hover:bg-radiant-hover flex items-center gap-2 text-slate-200"
                  >
                    <RotateCw className="w-3.5 h-3.5 text-cyan-300" />
                    <span>Rotate 90°</span>
                  </button>
          ...
          <div className="flex items-center gap-1 px-1.5 border-r border-radiant-border">
            {/* Presets */}
            <div className="relative">
              <button
                onClick={() => {
            ...
            <div className="relative">
              ...
              {showFilterMenu && onSetFilter && (
                <div className="absolute left-0 top-full mt-1 w-48 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-1 z-50 text-xs space-y-0.5">
                  <div className="px-2.5 py-1 text-[10.5px] font-semibold text-slate-400 border-b border-radiant-border">
                    Convolution Filters
                  </div>
                  {[
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden md:inline">LUT</span>
                <ChevronDown className="w-2.5 h-2.5 text-slate-400" />
              </button>

              {showLutMenu && (
                <div className="absolute left-0 top-full mt-1 w-44 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl py-1 z-50 text-xs">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden lg:inline">MIP</span>
                <ChevronDown className="w-2.5 h-2.5 text-slate-400" />
              </button>

              {showMipMenu && (
                <div className="absolute left-0 top-full mt-1 w-48 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-2 z-50 text-xs space-y-2">
          ...
          <div className="flex items-center gap-1 px-1.5 border-r border-radiant-border">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden lg:inline">{syncMode === 'none' ? 'Sync' : syncMode === 'index' ? 'Sync:Idx' : 'Sync:Loc'}</span>
                <ChevronDown className="w-2.5 h-2.5 text-slate-400" />
              </button>
            ...
            >
              ...
              <span className="hidden lg:inline">{isCinePlaying ? 'Stop' : 'Cine'}</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-1 px-1.5 border-r border-radiant-border">
            ...
            <div className="relative">
              ...
              {showGridMenu && (
                <div className="absolute left-0 top-full mt-1 w-32 bg-radiant-panel border border-radiant-border rounded-xl shadow-2xl p-1.5 z-50 text-xs">
        ...
        <div className="flex items-center gap-1 pl-1 shrink-0">
          ...
          >
            ...
            <span className="hidden xl:inline">PACS</span>
          </button>
          ...
          >
            ...
            <span className="hidden 2xl:inline">CD/DVD</span>
          </button>
