...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  // Click outside listener to dismiss open menus cleanly without any blocking overlay
  useEffect(() => {
  ...
  const toolBtnClass = (tool: ToolType) =>
    `flex flex-col items-center justify-center min-w-[40px] px-1.5 h-11 rounded transition-all select-none text-[10px] gap-0.5 ${
      activeTool === tool
  ...
  const actionBtnClass =
    'flex flex-col items-center justify-center min-w-[36px] px-1 h-11 rounded transition-all select-none text-[10px] gap-0.5 hover:bg-radiant-hover text-slate-300 border border-transparent';

  return (
    <div
      ref={toolbarRef}
      className="h-14 bg-radiant-panel border-b border-radiant-border flex items-center px-2 gap-1 relative z-50 select-none shrink-0 overflow-x-auto overflow-y-visible"
    >
      {/* 1. Main Navigation Tools (Windowing, Pan, Zoom, Loupe) */}
      <div className="flex items-center gap-0.5 pr-1 border-r border-radiant-border shrink-0">
        <button
      ...
      {/* 2. Direct Measurement & Annotation Tools (All visible and directly clickable) */}
      <div className="flex items-center gap-0.5 px-1 border-r border-radiant-border shrink-0">
        <button
        ...
        <button
          ...
          title="3-Point Angle Measurement [A]"
        ...
        <button
          ...
          title="Cobb Angle 4-Point Spinal Alignment Measurement"
        ...
        <button
          ...
          title="Rectangular ROI with HU Histogram [R]"
        ...
        <button
          ...
          title="Elliptical ROI with HU Histogram [E]"
        ...
        <button
          ...
          title="Real-Time Hounsfield Unit (HU) Density Probe"
      ...
      <div className="flex items-center gap-1 px-1 border-r border-radiant-border shrink-0">
      ...
      {/* 6. Multi-Viewport Grid Layout & 3D */}
      <div className="flex items-center gap-1 px-1 border-r border-radiant-border shrink-0">
        {/* Grid Dropdown */}
        <div className="relative">
          <button
